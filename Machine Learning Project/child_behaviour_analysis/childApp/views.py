...
class dataUploadView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            input_data = np.array([[age, screenTime, studyHours, mealsPerDay, sleepHours]])
...
#data_for_prediction =obj.pca(np.array(data_for_prediction),y_test)
            ...
            return render(request, "succ_msg.html", {'age':age,'screenTime':screenTime,'studyHours':studyHours,'mealsPerDay':mealsPerDay,'sleepHours':sleepHours,
                                                        'out':predicted_label})
